...
CFLAGS          = -Wall -Wno-overloaded-virtual -g -O2 -I$(top_builddir)
CXXFLAGS        = -Wall -Wno-overloaded-virtual -g -O2 -ggdb -pipe $(PICOPT) -I$(top_builddir)
WINSOCK_AVAIL   = 0
LDFLAGS		= 
...
UCSIM_LIBS	= $(patsubst %,-l%,$(LIB_LIST)) -lrt 
UCSIM_LIB_FILES	= $(patsubst %,lib%.a,$(LIB_LIST))

RELAY_LIBS	= $(patsubst %,-l%,ucsimutil) -lrt 
...
ftest$(EXEEXT): ftest.o libucsimutil.a
	$(CXX) $(CXXFLAGS) $(LDFLAGS) -o $@ $< -L$(top_builddir) -lucsimutil -lrt 
